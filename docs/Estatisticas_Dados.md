...
* coluna bl_atendido = 1 -> Corresponde a 1 venda

## 📊 Análise de cenários - Quantidade de registros

##  Informações Gerais

- **Arquivo origem.......: tb_ligacao_202602271123.csv**
- **Total de Registros...:** 346,906
- **Quantidade de Colunas:**      44
- _**Registros inválidos.:     26**_

---

### Válidos

- _**Quantidade:**_  14.501

    `trim(tdb.id_dsc_usuario) <> "0"`

    **OU**

    `trim(tdb.id_dsc_usuario) <> "0" or ( trim(tdb.id_lead) = "" or tdb.id_lead = null )`
    `and` `( trim(tdb.bl_atendido) = "" or tdb.bl_atendido = null )`
...
- `( trim(tdb.id_lead) = "" or tdb.id_lead = null )`
`and` `( trim(tdb.bl_atendido) = "" or tdb.bl_atendido = null )`

- `trim(tdb.id_dsc_usuario) = "0"`
`and` `( trim(tdb.id_lead) = "" or tdb.id_lead = null )`
`and` `( trim(tdb.bl_atendido) = "" or tdb.bl_atendido = null )`
...
| nm_dsc_campanha         | str     |          346906 |              1 |             0 | 0.0%       | 0.0%           | RETENCAO\_                    |           346906 |
